...
export function CustomerLayout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen bg-[#F5E6D3] relative overflow-x-hidden flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md z-10 h-full max-h-screen flex flex-col py-4 md:py-6 overflow-hidden">
        {/* Logo Header */}
        <div className="flex flex-col items-center mb-4 md:mb-6 flex-shrink-0">
          <div className="w-32 md:w-40 transition-transform duration-300">
            <img 
              src={logoUrl} 
        ...
        {/* Main Content Card */}
        <div className="glass-card rounded-3xl p-6 md:p-8 shadow-2xl ring-1 ring-black/5 flex-1 mb-16 md:mb-20 overflow-visible min-h-0">
          {children}
        </div>

        {/* Footer */}
        <p className="text-center text-stone-400 font-bold text-[10px] mt-2 uppercase tracking-widest opacity-60 flex-shrink-0">
