  ...
  return (
    <CustomerLayout hideLogo>
      <div className="flex flex-col h-full w-full overflow-hidden relative">
        {/* Main White Card */}
        <div className="glass-card rounded-3xl p-6 shadow-2xl ring-1 ring-black/5 flex flex-col items-center overflow-hidden mb-16 flex-1">
          {/* Brand Logo */}
          ...
          <motion.div
            ...
            className="bg-[#86C37A] text-white w-12 h-12 rounded-full flex items-center justify-center mb-3 shadow-sm flex-shrink-0"
          >
          ...
          {/* Side-by-Side Cards */}
          <div className="grid grid-cols-2 gap-3 w-full mb-6 flex-shrink-0">
        ...
        {/* Fixed Bottom Buttons - Stick to Screen Bottom */}
        <div className="absolute bottom-0 left-[-1rem] right-[-1rem] flex h-16 bg-white shadow-[0_-4px_10px_rgba(0,0,0,0.05)] z-50 overflow-hidden">
          <button className="flex-1 flex items-center justify-center gap-2 font-black text-stone-800 border-r border-stone-100 hover:bg-stone-50 transition-colors uppercase tracking-tight text-base px-2">
            <Share2 className="w-5 h-5" />
            <span className="whitespace-nowrap">Share with Friends</span>
          </button>
          <button className="flex-1 flex items-center justify-center gap-2 font-black text-white bg-[#FF9933] hover:bg-[#e68a2e] transition-colors uppercase tracking-tight text-base px-2">
